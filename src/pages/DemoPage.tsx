...
export default function DemoPage() {
   ...
   const { data: schoolsData, isLoading: schoolsLoading, error: schoolsError, refetch: refetchSchools } = useQuery({
      ...
      queryFn: async () => {
         ...
         // Using the real fetcher if backend was up, but here we might fail gracefully or return mock
         try {
            return await fetcher.get('/schools');
         } catch (e) {
            // Return mock data for demo purposes if backend fails
            return {
               data: [
                  { id: 1, name: "上海中学", district: "徐汇", type: "公办", score: 710 },
                  { id: 2, name: "华师大二附中", district: "浦东", type: "公办", score: 705 },
                  { id: 3, name: "复旦附中", district: "杨浦", type: "公办", score: 708 },
                  { id: 4, name: "建平中学", district: "浦东", type: "公办", score: 695 },
                  { id: 5, name: "七宝中学", district: "闵行", type: "公办", score: 698 },
               ],
               meta: { total: 5 }
            };
         }
